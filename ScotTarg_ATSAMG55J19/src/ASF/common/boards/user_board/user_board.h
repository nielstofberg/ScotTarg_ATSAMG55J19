...
/** Mic input pins */
#define MIC1_PIN					IOPORT_CREATE_PIN(PIOA,26) //PIO_PA26_IDX
#define MIC2_PIN					IOPORT_CREATE_PIN(PIOA,25) //PIO_PA25_IDX
#define MIC3_PIN					IOPORT_CREATE_PIN(PIOA,24) //PIO_PA24_IDX
#define MIC4_PIN					IOPORT_CREATE_PIN(PIOA,29) //PIO_PA29_IDX
