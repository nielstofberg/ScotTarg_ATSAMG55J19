...
/** Mic input pins */
#define MIC_PIO						PIOA
#define MIC_PIO_ID					ID_PIOA

#define MIC1_PIN_MASK				PIO_PA26	//IOPORT_CREATE_PIN(PIOA,26)
#define MIC2_PIN_MASK				PIO_PA25	//IOPORT_CREATE_PIN(PIOA,25)
#define MIC3_PIN_MASK				PIO_PA24	//IOPORT_CREATE_PIN(PIOA,24)
#define MIC4_PIN_MASK				PIO_PA29	//IOPORT_CREATE_PIN(PIOA,29)

#define MIC1_PIN					IOPORT_CREATE_PIN(PIOA,26)
#define MIC2_PIN					IOPORT_CREATE_PIN(PIOA,25)
#define MIC3_PIN					IOPORT_CREATE_PIN(PIOA,24)
#define MIC4_PIN					IOPORT_CREATE_PIN(PIOA,29)
